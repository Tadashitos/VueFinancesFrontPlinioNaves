    ...
    <v-container text-xs-center>
        <v-layout row wrap>
            ...
            <v-flex xs12 sm6 md8 lg8>
                ...
                <v-dialog v-model="showAccountCategoryDialog">
                    <AccountCategoryAdd
...
<script>
    ...
    export default {
        ...
        validations: {
            record: {
                type: { required },
                amount: { required, decimal, different: value => value !== 0 }, //different = retorna um valor booleano, verifica se o valor é maior ou igual a 0
                date: { required },
                accountId: { required },
                categoryId: { required },
        ...
        methods: {
            ...
            accountCategorySaved(item){
                ...
                this.record[`${this.entity}Id`] = item.id //${this.entity}Id = accountId ou categoryId
            },
            cancelDateDialog(){
